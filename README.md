...
- **"제일 급한 게 뭔가?"** → 구글 서치콘솔은 **이미 등록·사이트맵 제출 완료로 실측 확인**(8/18)됐습니다. 남은 병목은 ① 네이버 서치어드바이저 등록, ② 공개 전환(8/24 2편 시작, 5편 남음)입니다. 진단 배경은 [`docs/traffic-and-seo.md`](docs/traffic-and-seo.md), 실측 수치는 워크로그 참고.
...
| 2026-08-24 | **공개 전환 1회차** — ericreview 101 + hadesyi 404 공개 전환(101 색인 요청 완료, 404는 구글 접근 차단으로 미완). GSC 실적 상승 확인(ericreview 클릭 11→15회, 97번 노출 +5,750%). **RAG Reranker 원고 작성·사실검증 완료**(마지막 링크 부채 해소, 발행 대기) | [`docs/work-log-2026-08-24.md`](docs/work-log-2026-08-24.md) |
