...
- **"제일 급한 게 뭔가?"** → 구글 서치콘솔은 **이미 등록·사이트맵 제출 완료로 실측 확인**(8/18)됐습니다. 남은 병목은 ① 네이버 서치어드바이저 등록, ② 공개 전환(공개 4편 완료, 3편 남음)입니다. 진단 배경은 [`docs/traffic-and-seo.md`](docs/traffic-and-seo.md), 실측 수치는 워크로그 참고.
...
| 2026-08-25 | **공개 전환 2회차** — ericreview 102 + hadesyi 405 공개·색인요청 완료(누적 공개 4편). GSC 색인 증가 확인(ericreview 60→67, hadesyi 314→326). **리디렉션 오류 재검증 8/22 만료** — 12편 중 3편만 재크롤링, 남은 9편은 개별 색인 요청으로 전환. **05 원고(RAG Reranker) 410번 비공개 발행·검증 완료**(본문 11,136자, 마지막 링크 부채 해소) | [`docs/work-log-2026-08-25.md`](docs/work-log-2026-08-25.md) |
