...
| 2026-08-25 | **공개 전환 2회차** — ericreview 102 + hadesyi 405 공개·색인요청 완료(누적 공개 4편). GSC 색인 증가 확인(ericreview 60→67, hadesyi 314→326). **리디렉션 오류 재검증 8/22 만료** — 12편 중 3편만 재크롤링, 남은 9편은 개별 색인 요청으로 전환. **05 원고(RAG Reranker) 410번 비공개 발행·검증 완료**(본문 11,136자, 마지막 링크 부채 해소). **리디렉션 9편 중 4편 색인 요청 + 92번 색인 확인**. **06 원고(임베딩 모델 평가) 작성·검증 완료**(발행 대기) | [`docs/work-log-2026-08-25.md`](docs/work-log-2026-08-25.md) |
