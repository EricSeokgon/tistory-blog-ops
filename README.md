...
- **"직전 세션에서 무슨 일이 있었나?"** → [`docs/work-log-2026-08-26.md`](docs/work-log-2026-08-26.md)
...
- **"제일 급한 게 뭔가?"** → 구글 서치콘솔은 **이미 등록·사이트맵 제출 완료로 실측 확인**(8/18)됐습니다. **리디렉션 오류 12편은 8/26에 대응 완료**했습니다(원인: Googlebot 스마트폰의 `/m/` 모바일 경로). 남은 병목은 ① **색인 안 된 164개 중 얇은 글 비중**, ② 네이버 서치어드바이저 등록, ③ hadesyi 공개 전환(406·407·410)입니다. **공개 전환 시 발행일 갱신을 반드시 함께** 하십시오(원칙 6). 진단 배경은 [`docs/traffic-and-seo.md`](docs/traffic-and-seo.md), 실측 수치는 워크로그 참고.
